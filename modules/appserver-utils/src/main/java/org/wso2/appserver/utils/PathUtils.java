...
/**
 * This class defines file path related utility functions specific to WSO2 Application Server.
 *
 * @since 6.0.0
 */
public class PathUtils {
    ...
    public static Path getCatalinaConfigurationHome() throws AppServerException {
        return Paths.
                get(getCatalinaBase().toString(), Constants.TOMCAT_CONFIGURATION_FOLDER_NAME);
    }
    ...
    public static Path getWSO2ConfigurationHome() throws AppServerException {
        return Paths.
                get(getCatalinaConfigurationHome().toString(), Constants.WSO2_CONFIGURATION_FOLDER_NAME);
    }
