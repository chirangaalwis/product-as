    ...
    public static String encodeRequestMessage(RequestAbstractType requestMessage, String binding) throws SSOException {
        ...
        if (SAMLConstants.SAML2_REDIRECT_BINDING_URI.equals(binding)) {
            ...
            try (DeflaterOutputStream deflaterOutputStream = new DeflaterOutputStream(byteArrayOutputStream,
                    deflater)) {
                deflaterOutputStream.write(writer.toString().getBytes(Charset.forName(Constants.UTF8_ENCODING)));
            } catch (IOException e) {
            ...
            try {
                return URLEncoder.encode(encodedRequestMessage, Constants.UTF8_ENCODING).trim();
            ...
            return Base64.encodeBytes(writer.toString().getBytes(Charset.forName(Constants.UTF8_ENCODING)),
